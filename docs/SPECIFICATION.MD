...
| Accounts & New Life | Multi-account identity hangar with developer-tunable limits, starter currency grants, and sprite manifests for "New Life" profiles. | Enables persistent pilot identity, prestige loops, and UI-driven content drops without compromising determinism. |
